	...
	<br><br>
 	<%
		...
		<%
			...
			<form action="AddPackageNotifyServlet" method="post">
				...
				<br>
				Weight:<br>
					<input type="text" name="weight" value="<%=resultSet.getString("weight") %>"readonly>
				<br>
				Transport Type :<br>
