...
<br><br>
	...
	%>
			...
			<tr>
        		...
        		<td><a href="updateCargoShipment.jsp?shipmentID=<%=resultSet.getString("shipmentID")%>">update</a></td> 
        		<td><form action="DeleteCargoShipmentServlet" method="post">        		
		        	<input type="hidden" name="shipmentID" value="<%=resultSet.getString("shipmentID") %>"/>
